/**
 * Taken from metaplex common
 */

import { StringPublicKey } from "./extendBorsh"
import {
  SystemProgram,
  SYSVAR_RENT_PUBKEY,
...
// @ts-ignore
const findProgramAddress = (...args): [string, number] => PublicKey.findProgramAddress(...args).then(([a, b]) => [a.toBase58(), b]);
