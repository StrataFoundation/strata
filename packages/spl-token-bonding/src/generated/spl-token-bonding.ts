...
export type SplTokenBondingIDL = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "solStorage"; isMut: false; isSigner: false },
        { name: "wrappedSolMint"; isMut: false; isSigner: false },
        { name: "mintAuthority"; isMut: false; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "InitializeSolStorageV0Args" } }];
    },
    {
      name: "buyWrappedSolV0";
      accounts: [
        { name: "state"; isMut: false; isSigner: false },
        { name: "wrappedSolMint"; isMut: true; isSigner: false },
        { name: "mintAuthority"; isMut: false; isSigner: false },
        { name: "solStorage"; isMut: true; isSigner: false },
        { name: "source"; isMut: true; isSigner: true },
        { name: "destination"; isMut: true; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "BuyWrappedSolV0Args" } }];
    },
    {
      name: "sellWrappedSolV0";
      accounts: [
      ...
      args: [{ name: "args"; type: { defined: "SellWrappedSolV0Args" } }];
    },
    {
      name: "createCurveV0";
      accounts: [
      ...
      args: [{ name: "args"; type: { defined: "CreateCurveV0Args" } }];
    },
    {
      name: "initializeTokenBondingV0";
      accounts: [
      ...
      args: [
        { name: "args"; type: { defined: "InitializeTokenBondingV0Args" } }
      ];
    },
    {
      name: "closeTokenBondingV0";
    ...
    },
    {
      ...
      args: [{ name: "args"; type: { defined: "UpdateTokenBondingV0Args" } }];
    },
    {
      name: "buyV0";
      accounts: [
      ...
      args: [{ name: "args"; type: { defined: "BuyV0Args" } }];
    },
    {
      name: "sellV0";
      accounts: [
      ...
      args: [{ name: "args"; type: { defined: "SellV0Args" } }];
    }
  ];
  accounts: [
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "wrappedSolMint"; type: "publicKey" },
          { name: "solStorage"; type: "publicKey" },
          { name: "mintAuthorityBumpSeed"; type: "u8" },
          { name: "solStorageBumpSeed"; type: "u8" },
    ...
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [{ name: "definition"; type: { defined: "PiecewiseCurve" } }];
      };
    },
    {
      name: "tokenBondingV0";
      type: {
        ...
        fields: [
          ...
          { name: "baseStorage"; type: "publicKey" },
          { name: "buyBaseRoyalties"; type: "publicKey" },
          { name: "buyTargetRoyalties"; type: "publicKey" },
          { name: "sellBaseRoyalties"; type: "publicKey" },
          { name: "sellTargetRoyalties"; type: "publicKey" },
          ...
          { name: "curve"; type: "publicKey" },
          { name: "mintCap"; type: { option: "u64" } },
          { name: "purchaseCap"; type: { option: "u64" } },
          { name: "goLiveUnixTime"; type: "i64" },
          { name: "freezeBuyUnixTime"; type: { option: "i64" } },
          { name: "createdAtUnixTime"; type: "i64" },
          { name: "buyFrozen"; type: "bool" },
          { name: "sellFrozen"; type: "bool" },
          { name: "index"; type: "u16" },
          { name: "bumpSeed"; type: "u8" },
          { name: "baseStorageBumpSeed"; type: "u8" },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "minimumTargetAmount"; type: "u64" }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: "buyWithBase";
            type: { option: { defined: "BuyWithBaseV0Args" } };
          },
          {
            name: "buyTargetAmount";
            type: { option: { defined: "BuyTargetAmountV0Args" } };
          }
        ];
      };
    },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "curve"; type: { defined: "PrimitiveCurve" } },
          {
            name: "buyTransitionFees";
            type: { option: { defined: "TransitionFeeV0" } };
          },
          {
            name: "sellTransitionFees";
            type: { option: { defined: "TransitionFeeV0" } };
        ...
        variants: [
          {
            name: "TimeV0";
            fields: [
              { name: "curves"; type: { vec: { defined: "TimeCurveV0" } } }
            ];
          }
        ];
      };
  ...
  errors: [
    ...
    { code: 310; name: "PassedMintCap"; msg: "Passed the mint cap" },
    {
      code: 311;
      name: "OverPurchaseCap";
      msg: "Cannot purchase that many tokens because of purchase cap";
