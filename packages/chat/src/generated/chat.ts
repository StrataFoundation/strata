...
export type ChatIDL = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "namespaces"; isMut: true; isSigner: false },
        { name: "namespacesProgram"; isMut: false; isSigner: false },
        { name: "chatNamespace"; isMut: true; isSigner: false },
        { name: "userNamespace"; isMut: true; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "InitializeNamespacesArgsV0" } }];
    },
    {
      name: "claimAdminV0";
      accounts: [
        { name: "chat"; isMut: false; isSigner: false },
        {
          name: "identifierCertificateMintAccount";
          isMut: false;
          isSigner: false;
        },
        { name: "ownerWallet"; isMut: false; isSigner: true }
      ];
      args: [];
    },
    {
      ...
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "chat"; isMut: true; isSigner: false },
        { name: "namespaces"; isMut: false; isSigner: false },
        { name: "entry"; isMut: false; isSigner: false },
        { name: "identifierCertificateMint"; isMut: false; isSigner: false },
        {
          name: "identifierCertificateMintAccount";
          isMut: false;
          isSigner: false;
      ...
      args: [{ name: "args"; type: { defined: "InitializeChatArgsV0" } }];
    },
    {
      name: "initializeUnidentifiedChatV0";
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "chat"; isMut: true; isSigner: true },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [
        { name: "args"; type: { defined: "InitializeChatArgsV0" } },
    ...
    },
    {
      ...
      accounts: [
        { name: "refund"; isMut: true; isSigner: false },
        { name: "chat"; isMut: false; isSigner: false },
        { name: "chatPermissions"; isMut: true; isSigner: false },
        { name: "admin"; isMut: false; isSigner: true },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [];
    },
    {
      ...
      args: [
        { name: "args"; type: { defined: "InitializeChatPermissionsArgsV0" } }
      ];
    },
    {
      name: "initializeSettingsV0";
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "settings"; isMut: true; isSigner: false },
        { name: "ownerWallet"; isMut: false; isSigner: true },
        { name: "rent"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "InitializeSettingsArgsV0" } }];
    },
    {
      name: "initializeProfileV0";
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "walletProfile"; isMut: true; isSigner: false },
        { name: "namespaces"; isMut: false; isSigner: false },
        { name: "entry"; isMut: false; isSigner: false },
        { name: "identifierCertificateMint"; isMut: false; isSigner: false },
        {
      ...
      args: [{ name: "args"; type: { defined: "InitializeProfileArgsV0" } }];
    },
    {
      name: "initializeDelegateWalletV0";
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "delegateWallet"; isMut: true; isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        { name: "chat"; isMut: false; isSigner: false },
        { name: "chatPermissions"; isMut: false; isSigner: false },
        { name: "sender"; isMut: false; isSigner: false },
        { name: "signer"; isMut: false; isSigner: true },
        { name: "postPermissionAccount"; isMut: true; isSigner: false },
        { name: "postPermissionMint"; isMut: true; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "MessagePartV0" } }];
    },
    {
      name: "sendNativeMessageV0";
      accounts: [
    ...
    },
    {
      ...
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "namespaces"; isMut: false; isSigner: false },
        { name: "chatNamespace"; isMut: false; isSigner: false },
        { name: "claimRequest"; isMut: true; isSigner: false },
        { name: "entry"; isMut: true; isSigner: false },
        { name: "caseInsensitiveMarker"; isMut: true; isSigner: false },
        { name: "certificateMintMetadata"; isMut: true; isSigner: false },
        { name: "namespacesProgram"; isMut: false; isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "namespaces"; isMut: false; isSigner: false },
        { name: "userNamespace"; isMut: false; isSigner: false },
        { name: "claimRequest"; isMut: true; isSigner: false },
        { name: "entry"; isMut: true; isSigner: false },
        { name: "caseInsensitiveMarker"; isMut: true; isSigner: false },
        { name: "certificateMintMetadata"; isMut: true; isSigner: false },
  ...
  accounts: [
    {
      ...
      type: {
        ...
        fields: [
          { name: "bump"; type: "u8" },
          { name: "chatNamespace"; type: "publicKey" },
          { name: "userNamespace"; type: "publicKey" }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "bump"; type: "u8" },
          { name: "chatType"; type: { defined: "ChatType" } },
          { name: "name"; type: "string" },
          { name: "imageUrl"; type: "string" },
          { name: "metadataUrl"; type: "string" },
          { name: "postMessageProgramId"; type: "publicKey" },
          { name: "admin"; type: { option: "publicKey" } },
          { name: "identifierCertificateMint"; type: { option: "publicKey" } }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "bump"; type: "u8" },
          { name: "chat"; type: "publicKey" },
          { name: "postPermissionType"; type: { defined: "PermissionType" } },
          { name: "readPermissionType"; type: { defined: "PermissionType" } },
          { name: "postPermissionKey"; type: "publicKey" },
          { name: "readPermissionKey"; type: "publicKey" },
          { name: "postPermissionAmount"; type: "u64" },
          { name: "defaultReadPermissionAmount"; type: "u64" },
          { name: "postPermissionAction"; type: { defined: "PostAction" } },
          { name: "postPayDestination"; type: { option: "publicKey" } }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "identifierCertificateMint"; type: "publicKey" },
          { name: "imageUrl"; type: "string" },
          { name: "metadataUrl"; type: "string" }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "bump"; type: "u8" },
          { name: "ownerWallet"; type: "publicKey" },
          { name: "encryptedDelegateWallet"; type: "string" },
          { name: "encryptedSymmetricKey"; type: "string" }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "ownerWallet"; type: "publicKey" },
          { name: "delegateWallet"; type: "publicKey" }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "bump"; type: "u8" },
          { name: "certificateMint"; type: "publicKey" }
        ];
      };
    }
  ];
  types: [
    ...
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "chatNamespaceName"; type: "string" },
          { name: "userNamespaceName"; type: "string" },
          { name: "chatNamespaceBump"; type: "u8" },
          { name: "userNamespaceBump"; type: "u8" }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "id"; type: "string" },
          { name: "totalParts"; type: "u16" },
          { name: "currentPart"; type: "u16" },
          { name: "readPermissionAmount"; type: "u64" },
          { name: "encryptedSymmetricKey"; type: "string" },
          { name: "content"; type: "string" },
          { name: "conditionVersion"; type: "u8" },
          { name: "messageType"; type: { defined: "MessageType" } },
          { name: "referenceMessageId"; type: { option: "string" } },
          { name: "readPermissionKey"; type: "publicKey" },
          { name: "readPermissionType"; type: { defined: "PermissionType" } }
        ];
      };
    ...
    },
    {
      ...
      type: {
        kind: "enum";
        variants: [{ name: "Hold" }, { name: "Burn" }, { name: "Pay" }];
      };
    },
    {
      name: "PermissionType";
      type: {
        kind: "enum";
        variants: [{ name: "Token" }, { name: "NFT" }, { name: "Native" }];
      };
    },
    {
      name: "ChatType";
      type: {
        kind: "enum";
        variants: [{ name: "Identified" }, { name: "Unidentified" }];
      };
    }
  ];
  events: [
    {
      name: "MessagePartEventV0";
      fields: [
        { name: "chat"; type: "publicKey"; index: false },
        { name: "sender"; type: "publicKey"; index: false },
        { name: "signer"; type: "publicKey"; index: false },
        { name: "message"; type: { defined: "MessagePartV0" }; index: false }
      ];
    }
  ];
  errors: [
  ...
  metadata: { address: "chatGL6yNgZT2Z3BeMYGcgdMpcBKdmxko4C5UhEX4To" };
};
...
export type CaseInsensitiveMarkerV0 =
  IdlAccounts<ChatIDL>["caseInsensitiveMarkerV0"];
