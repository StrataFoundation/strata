...
What if the value of your token was not just from your own efforts, but also the built on a community? A group of people can pool resources and bring about innovation on a larger scale.

At the heart of Strata are [Bonding Curves](/docs/learn/bonding_curves) that allow free and instant trading of a token without the need for an exchange or liquidity provider. These inherantly express one tokens value in terms of a base token's value. That base token is your *Collective*
