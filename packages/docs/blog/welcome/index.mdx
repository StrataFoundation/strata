...
Because of this Automated Market Maker (AMM), your token's value is directly tied to that a base token's value. That base token is your *Collective*. Price your token in SOL, and your succss is bound to SOLs success, and SOLs success is yours.
...
Strata is here provide infrastructure for the next wave of innovation in the Creator Economy. The most creative business models have yet to be discovered.
As such, the protocol remains as non opinionated and prescriptive as possible. 

A large amount of customization is available to enable new and innovative models. 
...
This might sound complicated, but with sane defaults you don't have to reach under the hood.

## Next Steps

Like what you've read? Build! From office hours to hands on assistance in our Discord, we'll be there to help you along the way! 

<CTA />

Not a dev? [Wum.bo](https://wum.bo) will be launching a chrome extension to create tokens with one-click right in Twitter. More integrations are on the way!
