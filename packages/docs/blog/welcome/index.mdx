...
We are here to give builders the primitives they need to launch the **Cooperation Economy**. 

The goal is simple: make it easier for talented people to work together on launching productive networks and communities. 
Strata Social Tokens empower the individual, while Strata Collectives make it possible to pool resources to build powerful shared incentive structures.
...
The power of a token is in shared ownership. Unlike equity, where it makes sense to keep as many shares as possible; a token acts more like a currency. If a handful of people held every US Dollar, the dollar would be worthless.

All token holders are incentive aligned to drive value and utility for that token. A group of people can pool resources and bring about innovation on a larger scale.
...
That underlying token is your *Collective*. Price your token in SOL, and your succss is bound to SOLs success, and SOLs success is yours.
