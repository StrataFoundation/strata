...
description: How to create and launch your own spl token on Solana
tags: [guides, launchpad]
authors: [noah]
image: ./logo.png
keywords: [how to, launch, create, spl token, solana, token, launchpad, permissionless, open source, social token, gamefi token]
---
