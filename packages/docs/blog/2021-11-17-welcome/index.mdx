...
Strata is the fastest and least expensive way to create social tokens and social collectives, powered by Solana. After months in development, the Strata protocol was officially open sourced today. 
We owe a big thanks to our community and the Solana community for helping us get here. [Get started here](/docs/getting_started)

**Strata Social Tokens** unlock local economies around individuals while **Strata Collectives** make it possible to pool resources and structure incentive models that traverse multiple social token networks. The combination of these composable tokens mechanisms will fuel not only the Creator Economy, but will unlock a new Cooperation Economy that compounds the value of social token networks. Combined, Strata has the potential to upend entrenched, rent-seeking business models that have taxed creators for decades and unlock a wider design space for social tokens. 

Strata’s mission is simple: make it radically easier for people to coordinate social communities. The definition of community is up to you. Whether that means creating a community exclusively for your fans, building a membership-based record label, integrating social tokens into an existing network, or building local chapters within divisions for an international movement—the decision is yours to create. 

Strata is for creators, builders, and entrepreneurs who seek to integrate tokens, and novel experiences around tokens, at the heart of their communities. No project is too big or too small—social tokens should be, and will be, everywhere. In addition to unlocking social tokens on Solana, Strata makes it ridiculously cheap and easy to launch and experiment with them. 

## How Does Strata Work?

Social tokens are tokens typically associated with an individual or project. There are many flavors of social tokens but they typically provide access, status, and utility related to the individual they represent. Strata takes this idea further and provides a new way to bundle social token networks into collectives, which are networks of social tokens bound by a common collective token. 
...
**Collectives** are for like-minded creators that want to pool resources and bond their directional success to others. Within collectives, every token holder is bound to the collective and  incentive-aligned to increase not only the value of their token, but the value of the collective as a whole. Imagine a group of artists forming a collective for their genre and pooling resources to create a custom marketplace. Imagine a Decentralized Autonomous Organization (DAO) with a token and a collective of contributors with tokens bound to the DAO token. Imagine the ability to bootstrap an entire economy around an idea.
...
Creators can join collectives by basing their tokens in the native collective token at the point of creation. Collective creators have the ability to make collectives open or closed. 
...
Don't believe us? Here’s how you can create a social token on devnet right now: 
