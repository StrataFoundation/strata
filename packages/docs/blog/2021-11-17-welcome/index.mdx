...
**Strata Social Tokens** unlock local economies around individuals while **Strata Collectives** make it possible to pool resources and structure incentive models that traverse multiple social token networks. 
The combination of these composable tokens mechanisms will fuel not only the Creator Economy, but will unlock a new Cooperation Economy that compounds the value of social token networks. 
Combined, Strata has the potential to upend entrenched, rent-seeking business models that have taxed creators for decades and unlock a wider design space for social tokens. 
...
**Collectives** are for like-minded creators that want to pool resources and bond their directional success to others. 
Within collectives, every token holder is bound to the collective and incentive-aligned to increase not only the value of their token, but the value of the collective as a whole. 
Imagine a group of artists forming a collective for their genre and pooling resources to create a custom marketplace. 
...
Collectives also allow fans to take directional positions on the success of groups or categories rather than individuals alone.
Viewed through this lens, collectives can be seen as idea indices.
...
Wum.bo brings social tokens directly into social networks (Twitter, Twitch, Reddit, etc.) and makes it possible to see the economy surrounding an individual inline with their profile picture.
...
Strata was designed to eventually become a standard for social tokens and bonding curves. The most innovative business models have yet to be discovered.
