...
**Collectives** are a new approach for like-minded creators to monetize the efforts of group cooperation.
They allow a community or business to structure incentive models designed to increase the value of the collective as a whole, in tandem with the efforts of individuals. Collectives allow participants to pool resources with their network of social tokens. 
Imagine a group of artists forming a collective and working in partnership to create a custom marketplace. Or perhaps a Decentralized Autonomous Organization (DAO) formed by an organization of contributors with their individual tokens bound to the DAO token. Collectives are a way to form economies around ideas, and to seamlessly integrate Strata Protocol into your business model.
