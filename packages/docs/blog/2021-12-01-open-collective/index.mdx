...
Collectives are a new approach for like-minded creators to monetize the efforts of group cooperation. A collective is a group of social tokens that have bonded their direction success to a base token. Collectives allow participants to pool resources with their network of social tokens. They allow a community or business to structure incentive models aligned to increase the value of the collective as a whole, along with their individual tokens. Collectives reorient directional goals towards the success of groups rather than individuals alone. 

Collectives allow communities and fans to contribute to the success of ideas, groups, or categories. Viewed through this lens, collectives can be seen as index for ideas. Collectives are the beginning of an intersection between creators and communities working together for a common purpose.

Strata Collectives have the potential to upend entrenched, royalty-seeking business models which have taxed creators for decades. Imagine a group of artists forming a collective and pooling resources to create a custom marketplace. Imagine a Decentralized Autonomous Organization (DAO) formed by an organization of contributors with their individual tokens bound to the DAO token. Collectives are a way to seamlessly integrate Strata Protocol into your business model, or to form economies around ideas.
