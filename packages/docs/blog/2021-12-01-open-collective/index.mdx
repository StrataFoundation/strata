...
The teams of both Strata and Wum.bo want to see the Open Collective succeed because the want to see the entire protocol succeed. They want to drive value into this newly forming economy. Neither team, however, will ever pick sides or choose winners amongst collectives.
