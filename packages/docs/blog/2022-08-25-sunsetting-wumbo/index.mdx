...
Today we're sad to announce that, after multiple conversations and contemplation amongst the team, we have decided its time to sunset Wum.bo.

If you participated in Wumbo/OPEN, you should use the following interface to recoup your SOL. 

Because the team never took a cut of $OPEN (it had 0% royalties), and it uses a bonding curve directly to SOL,
everyone who participated can claim a share of the reserves of these curves. As of writing this, $OPEN has
around ~$166k worth of SOL in its reserves. Those will be split evenly for each $OPEN. We have made $OPEN, and 
every bonding curve based on $OPEN, flat. There is no advantage to cashing out before anyone else.

Thanks for giving Wumbo a try. Our team greatly appreciated you and your early support!
...
Social Tokens have struggled to find product market fit. It has become clear that social tokens, in their current form,
