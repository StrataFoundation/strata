...
<UrlDisplay subs={["candyMachineId", "tokenBondingKey"]} value="https://docs.strataprotocol.com/launchpad/admin/dynamic-pricing-mint?candyMachineId=:candyMachineId&tokenBondingKey=:tokenBondingKey&cluster=:cluster" />

The url for the mint:

<UrlDisplay subs={["candyMachineId"]} value="https://app.strataprotocol.com/lbcs/mint/:candyMachineId?cluster=:cluster" />
