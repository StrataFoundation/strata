...
export const SplTokenCollectiveIDLJson: Idl & {
...
export type SplTokenCollectiveIDL = {
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "tokenRef"; isMut: false; isSigner: false },
        { name: "primaryTokenRef"; isMut: true; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "SetAsPrimaryV0Args" } }];
    },
    {
      name: "initializeOwnedSocialTokenV0";
      accounts: [
      ...
      args: [
        { name: "args"; type: { defined: "InitializeSocialTokenV0Args" } }
      ];
    },
    {
      name: "initializeUnclaimedSocialTokenV0";
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "newBuyBaseRoyalties"; isMut: true; isSigner: false },
      ...
      args: [{ name: "args"; type: { defined: "ClaimSocialTokenV0Args" } }];
    },
    {
      name: "updateTokenBondingV0";
      accounts: [
    ...
    },
    {
      ...
      args: [
        { name: "args"; type: { defined: "ChangeOptStatusClaimedV0Args" } }
      ];
    },
    {
      name: "updateOwnerV0";
      accounts: [
        { name: "payer"; isMut: true; isSigner: true },
        { name: "newOwner"; isMut: false; isSigner: true },
        { name: "baseMint"; isMut: false; isSigner: false },
        { name: "owner"; isMut: false; isSigner: true },
        { name: "oldOwnerTokenRef"; isMut: true; isSigner: false },
        { name: "newOwnerTokenRef"; isMut: true; isSigner: false },
        { name: "mintTokenRef"; isMut: true; isSigner: false },
        { name: "oldPrimaryTokenRef"; isMut: true; isSigner: false },
        { name: "newPrimaryTokenRef"; isMut: true; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "UpdateOwnerV0Args" } }];
    },
    {
      name: "updateAuthorityV0";
      accounts: [
      ...
      args: [{ name: "args"; type: { defined: "UpdateAuthorityV0Args" } }];
    }
  ];
  accounts: [
    {
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "unclaimedTokenMetadataSettings";
            type: { option: { defined: "TokenMetadataSettingsV0" } };
          },
          {
            name: "unclaimedTokenBondingSettings";
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "nameIsNameServiceName"; type: "bool" }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "curve"; type: { option: "publicKey" } },
          { name: "minSellBaseRoyaltyPercentage"; type: { option: "u32" } },
          { name: "minSellTargetRoyaltyPercentage"; type: { option: "u32" } },
          { name: "maxSellBaseRoyaltyPercentage"; type: { option: "u32" } },
          { name: "maxSellTargetRoyaltyPercentage"; type: { option: "u32" } },
          { name: "minBuyBaseRoyaltyPercentage"; type: { option: "u32" } },
          { name: "minBuyTargetRoyaltyPercentage"; type: { option: "u32" } },
          { name: "maxBuyBaseRoyaltyPercentage"; type: { option: "u32" } },
          { name: "maxBuyTargetRoyaltyPercentage"; type: { option: "u32" } },
          { name: "targetMintDecimals"; type: { option: "u8" } },
          { name: "buyBaseRoyalties"; type: { defined: "RoyaltySettingV0" } },
          { name: "sellBaseRoyalties"; type: { defined: "RoyaltySettingV0" } },
          { name: "buyTargetRoyalties"; type: { defined: "RoyaltySettingV0" } },
          {
            name: "sellTargetRoyalties";
            type: { defined: "RoyaltySettingV0" };
          },
          { name: "minPurchaseCap"; type: { option: "u64" } },
          { name: "maxPurchaseCap"; type: { option: "u64" } },
          { name: "minMintCap"; type: { option: "u64" } },
          { name: "maxMintCap"; type: { option: "u64" } }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "tokenBondingAuthority"; type: { option: "publicKey" } },
          { name: "buyBaseRoyaltyPercentage"; type: "u32" },
          { name: "buyTargetRoyaltyPercentage"; type: "u32" },
          { name: "sellBaseRoyaltyPercentage"; type: "u32" },
          { name: "sellTargetRoyaltyPercentage"; type: "u32" },
    ...
    {
      name: "ChangeOptStatusClaimedV0Args";
      type: { kind: "struct"; fields: [{ name: "isOptedOut"; type: "bool" }] };
    },
    {
      name: "UpdateOwnerV0Args";
      type: {
        ...
        fields: [
          { name: "ownerTokenRefBumpSeed"; type: "u8" },
          { name: "primaryTokenRefBumpSeed"; type: "u8" }
        ];
      };
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [{ name: "newAuthority"; type: "publicKey" }];
      };
    },
    {
      name: "UpdateMetadataAccountArgs";
  ...
  errors: [
    ...
    { code: 6002; name: "InvalidAuthority"; msg: "Invalid authority passed" },
    {
      code: 6003;
      name: "InvalidTokenBondingSettings";
      msg: "Bonding curve had invalid settings to join this collective";
    ...
    { code: 6006; name: "IncorrectOwner"; msg: "Incorrect owner on account" },
    { code: 6007; name: "NoBonding"; msg: "Token is not on a bonding curve" },
    { code: 6008; name: "InvalidCollective"; msg: "Invalid collective" },
    {
      code: 6009;
      name: "InvalidNameAuthority";
      msg: "Invalid name authority passed";
