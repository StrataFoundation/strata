...
interface ICreateChatStep3Props {
  onBack: () => void;
  onNext: () => void;
}

export const CreateChatStep3: React.FC<ICreateChatStep3Props> = ({
  onBack,
  onNext,
}) => {
  return (
    <VStack w="full" alignItems="start" gap={6} spacing={0}>
      <Box>
        <Text fontWeight="bold" fontSize="md">
          What kind of post messages do you want
        </Text>
        <Text fontSize="xs" fontWeight="normal">
          How do you want to gate the ability to post messages in your chat?
        </Text>
      </Box>
