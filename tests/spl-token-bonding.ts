...
import { NATIVE_MINT, Token, ASSOCIATED_TOKEN_PROGRAM_ID, AccountInfo as TokenAccountInfo, u64 } from '@solana/spl-token';
...
describe('spl-token-staking', () => {
  ...
  describe('with normal base mint', () => {
    ...
    it ("allows updating token bonding", async () => {
      ...
      // @ts-ignore
      expect(tokenBondingNow.authority.toBase58()).to.equal(tokenBondingProgram.wallet.publicKey.toBase58());
